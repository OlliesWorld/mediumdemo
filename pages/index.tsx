    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className='flex justify-between items-center bg-yellow-400 border-y border-black py-10 lg:py-0'>
        <div className='px-10 space-y-5'>
          <div className='text-6xl max-w-xl font-serif'><span className='underline decoration-black decoration-4'>Medium</span> is a place to write, read and connect</div>
          <div className='text-xl'>It's easy and free to post your thinking on any topic and connect with millions of readers.</div>
        </div>
